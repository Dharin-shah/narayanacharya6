...
var cnv;
var currentColor = backgroundColors[currentIndex];
var targetColor = backgroundColors[currentIndex+1];
...
function draw() {
  var result = transition(currentColor, targetColor);
  currentColor = result.currentColor;
  if(result.moveToNext) {
    currentIndex = (currentIndex + 1 ) % backgroundColors.length;
    // currentColor = targetColor;
    targetColor = backgroundColors[currentIndex];
    console.log("Moving to " + targetColor);
  }
...
/* ========= Required Functions For Background Color Transition  ========= */
...
function transition(currentColor, targetColor) {
  targetColor	= hex2rgb(targetColor);
  currentColor = hex2rgb(currentColor);
  ...
  // return the new modified color
  targetColor = rgb2hex(targetColor);
  currentColor = rgb2hex(currentColor);
  var moveToNext = false;
  if (increment[0] == 0 && increment[1] == 0 && increment[2] == 0) {
    moveToNext = true;
  }
  return {currentColor: currentColor, moveToNext: moveToNext};
}
